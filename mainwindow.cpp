...
//            // DEBUG打印前10个点
//            for (int i = 0; i < std::min(10, dataLength); ++i) {
//                qDebug() << "[DEBUG] X[" << i << "]=" << pMainWindow->m_dScannerBufferX[i]
//                         << "Z[" << i << "]=" << pMainWindow->m_dScannerBufferZ[i]
//                         << "I[" << i << "]=" << pMainWindow->m_iScannerBufferI[i];
//            }
